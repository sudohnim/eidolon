...
# MitreTechnique lives in core.models (the scan state carries it as a typed
# field); re-exported here for backward-compatible imports.
from eidolon.core.state import MitreTechnique  # noqa: E402, F401
